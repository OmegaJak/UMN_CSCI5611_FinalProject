...
const char* INSTRUCTIONS =
    "***************\n"
    "This is a sound synthesis and propagation simulation made by Jackson Kruger and Xinghua Hao for CSCI 5611 at the University of Minnesota.\n"
    "\n"
    "Controls:\n"
    "1-8 number keys: Pluck the corresponding string\n"
    "1-6 on the numpad: Select which parameter to modify\n"
    "m: Toggle environmental echos\n"
    "WASD - Camera movement\n"
    "R/F - Camera up/down\n"
    "+/- - Increase/decrease various parameters, depending on which parameter is currently selected for tuning. The amount the parameters change by can be modified with these:\n"
    "   Shift - Change by 10x the base amount\n"
    "   Ctrl - Change by 0.1x the base amount\n"
    "Shift while moving - Make the camera movement faster\n"
    "Esc - Quit\n"
    "F11 - Fullscreen\n"
    "***************\n";
        ...
        while (SDL_PollEvent(&windowEvent)) {  // inspect all events in the queue
            ...
            if (windowEvent.type == SDL_KEYUP) {  // Exit event loop
                if (windowEvent.key.keysym.sym == SDLK_ESCAPE) {
                    ...
                    clothManager.Pluck(index, 0.4, 0);
